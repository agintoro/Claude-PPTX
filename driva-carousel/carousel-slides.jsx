  ...
  return (
    <div className="ig-slide ig-slide--ink" data-screen-label="01 · Hook">
      ...
      <main style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: '56px', position: 'relative', zIndex: 2 }}>
        ...
        <h1 className="ig-display">Slow<br />coffee.<br /><span className="dim">Short<br />window.</span></h1>
        <p className="ig-sub">Pre-order First Batch DRIVA ditutup <strong>15 Juni 2026, pukul 18.00</strong> — dan tidak dibuka lagi sampai batch berikutnya.</p>
  ...
  return (
    <div className="ig-slide" data-screen-label="02 · Thank you">
      ...
      <main style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: '64px', position: 'relative', zIndex: 2 }}>
        ...
        <p className="ig-quote">To everyone who trusted us before the first bag even shipped — <span className="accent">this batch is yours.</span></p>
        <p className="ig-sub">Kepada para klien yang sudah memesan lebih dulu: kepercayaan kalian adalah alasan First Batch ini ada. Setiap lot kami proses seperti janji yang harus ditepati.</p>
      ...
      <main style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: '40px' }}>
        ...
        <div className="ig-row">
          ...
          <div className="ig-row-body">
            ...
            <p className="ig-row-note">Roasting selesai, pesanan dikirim bertahap.</p>
          </div>
  ...
  return (
    <div className="ig-slide ig-slide--ink" data-screen-label="04 · Deadline">
      ...
      <main style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: '70px', position: 'relative', zIndex: 2 }}>
        ...
        <p className="ig-sub">Setelah itu, First Batch resmi ditutup. Yang sudah memesan tinggal menunggu kabar pengiriman — yang belum, menunggu Batch 2.</p>
      </main>
      ...
      <main style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: '40px', position: 'relative', zIndex: 2 }}>
        ...
        <div className="ig-step">
          ...
          <div className="ig-step-body">
            ...
            <p className="ig-step-note">Lihat semua lot yang tersedia di First Batch.</p>
          </div>
        </div>
        <div className="ig-step">
          ...
          <div className="ig-step-body">
            ...
            <p className="ig-step-note">Setiap lot dicatat dari fermentasi sampai resting.</p>
          </div>
        </div>
        <div className="ig-step">
